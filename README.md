...
Aplikacja webowa w Streamlit, służąca do pobierania, analizy i wizualizacji kursów walut z Narodowego Banku Polskiego (NBP).
Umożliwia przeglądanie kursów w czasie, obliczanie zmian dziennych, średnich kroczących, odchyleń, relacji między walutami, wskaźników siły waluty oraz korelacji.
